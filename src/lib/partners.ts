...
export const partners: Partner[] = [
  ...
  },
  {
    ...
    connectionCards: [
      {
        ...
        content: [
          "In 25 years, ODI has gone from a kayak shack in Mission Bay to a $17 million Living Lab in the heart of City Heights \u2014 complete with a Scientist-in-Residence studio, live-streaming ocean views, and a Leadership Pathway wall celebrating alumni. You serve 6,000+ students a year across every school in the Hoover cluster. Your Ocean Leaders learn to swim and snorkel, do rocky intertidal research at La Jolla Tidepools, visit Scripps, travel to Mexico for fieldwork. You've won the Presidential Award. NOAA funds you. Charity Navigator gives you 4 stars. Anai Novoa, Class of 2007, now coordinates summer programs at Scripps and sits on your Science Advisory Council.",
    ...
    partnershipIdeas: [
      { title: "Ocean Leaders \u2014 Freediving as a STEM Skill", description: "Ocean Leaders starts the summer before 9th grade with a 12-day Bridge program. The following summer, students learn to swim and snorkel, visit Mexico for fieldwork, and interact with sea life. In 9th grade, they do rocky intertidal research at La Jolla Tidepools. Freediving is the natural next step in this progression \u2014 it takes students who can already snorkel and gives them breath-hold capability, equalization skills, and the ability to observe below the surface. An AIDA certification is internationally recognized and directly applicable to marine science careers. We'd offer sponsored AIDA certification for Ocean Leaders as part of their 10th or 11th grade summer intensive." },
