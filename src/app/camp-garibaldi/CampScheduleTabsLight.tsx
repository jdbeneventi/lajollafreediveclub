...
const FIVE_DAY = [
  ...
  { day: "Day 4", name: "The Canyon", ecosystem: "Big Water", theme: "The big blue day.", items: ["Canyon geology and upwelling", "Canyon rim dives to 20–35 ft", "Octopus, fringeheads, gorgonians", "Feel and describe the thermocline"] },
