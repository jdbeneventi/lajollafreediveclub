...
const programs = [
  ...
  { id: "group", title: "Group Ocean Sessions", meta: "On pause", desc: "Weekly guided dives — currently on pause while courses run. We'll announce when they return.", href: "/programs" },
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {testimonials.map((t, i) => (
              <Reveal key={i} delay={i * 80}>
                <div className={`bg-white rounded-xl p-8 relative ${i % 2 === 1 ? "md:translate-y-6" : ""}`}>
