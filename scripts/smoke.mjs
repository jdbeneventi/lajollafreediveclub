...
// ─────────────────────────────────────────────────────────────────────
const ADMIN = ["/api/admin/students", "/api/admin/onboarding", "/api/admin/inquiries", "/api/admin/inquiries/intel", "/api/admin/inquiries/act", "/api/admin/email-sync", "/api/admin/stripe-sync", "/api/admin/gear", "/api/telegram"];
